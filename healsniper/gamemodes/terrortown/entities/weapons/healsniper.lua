if SERVER then
	AddCSLuaFile()
	//resource.AddWorkshop("1272152406")
else
	LANG.AddToLanguage("english", "awp_name", "AWP Healing Sniper")
	LANG.AddToLanguage("english", "awp_desc", "Heals on any hit, headshot and when getting a kill.\n\nOnly has five shots.")
